...
module ECpayPayment
    ...
    def aio_check_out_credit_onetime(params:, invoice:{}) # 信用卡單次
    ...
    def aio_check_out_credit_divide(params:, invoice:{}, installment: , amount: ) # 分期
    ...
    def aio_check_out_credit_period(period_info:, params:, invoice:{}) # 定期定額
